...
<html lang="en" style="overflow-x : hidden;">
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="font/inter-ui/inter-ui.css" />
  ...
  <body cz-shortcut-listen="true">
            ...
            <div class="pure-menu">
              <ul class="pure-menu-list">
                ...
                <li class="pure-menu-item">
                  <a href="home.php" id="all" class="pure-menu-link">All</a>
                </li>
                <li class="pure-menu-item">
                  <a class="pure-menu-link" id="tech" data-anim="la-anim-1">Technology</a>
                </li>
                <li class="pure-menu-item">
                  <a id="design" class="pure-menu-link" data-anim="la-anim-1">Design</a>
                </li>
                <li class="pure-menu-item">
                  <a id="ent" class="pure-menu-link" data-anim="la-anim-1">Entertainment</a>
                </li>
                <li class="pure-menu-item">
                  <a id="travel" class="pure-menu-link" data-anim="la-anim-1">Travel</a>
                </li>
                <li class="pure-menu-item">
                  <a id="fashion" class="pure-menu-link" data-anim="la-anim-1">Fashion</a>
                </li>
                <li class="pure-menu-heading">Account</li>
                <li class="pure-menu-item">
                  <a href="userprofile.php" class="pure-menu-link">Profile</a>
                </li>
                <li class="pure-menu-item">
                  <a href="settings.php" class="pure-menu-link">Settings</a>
                </li>
                <li class="pure-menu-item">
                  <a href="logout.php" class="pure-menu-link">Logout</a>
                </li>
                <li class="pure-menu-item">
                  <a href="aboutus.html" class="pure-menu-link" style="opacity:0.9;" id="about_us">About Us</a>
                </li>
              </ul>
            </div>
          </div>
    ...
    <div id="top" class="nav-header">
      <div class="pure-menu pure-menu-horizontal">
        <ul class="pure-menu-list">
          <li class="pure-menu-item">
            <a href="home.php" class="pure-menu-link top" id="recent_post">Recent</a>
          </li>
          <li class="pure-menu-item">
            <a id="popular" data-anim="la-anim-1" class="pure-menu-link top">Popular</a>
          </li>
          <li class="pure-menu-item">
            <a href="new-post.php" class="pure-menu-link top">New Post</a>
          </li>
          <li class="pure-menu-item">
            <div class="box">
          ...
          <li class="pure-menu-item" id="user_image">
            ...
            {?>
              <div class="post-avatar" style="background-image: url(" ../img/default.png
                "); position: fixed; left: 373px; border-radius: 50%; height: 45px; margin-bottom: -160px; margin-left: 925px; width: 49px; z-index: 3; background-size: 48px auto; margin-top: 10px;"></div>
              <?php }
            else
              {?>
    ...
    <div class = "articles" >
      <div class = "items">
        <div class="posts">
          <!-- A single blog post -->
          <h2 class="post-title">
            <span data-field="post-title"></span>
          </h2>
          By
          <a class="post-author" href="javascript:openProfile()" data-field="post-author"></a> under
          <a class="post-category post-category-pure" id="category" data-field="post-category"></a>
          <p class="post-description">
            <span data-field="post-description"></span>
            <a class="continue-reading" href="javascript:openArticle()">. . .Read More
              <span id="data" data-field="article_id"></span>
      ...
      <div id="la-buttons" class="column">
        <button class="btn btn-info pure-button load-more" id="all-load" data-anim="la-anim-1">Show Older Posts
    ...
    <div class = "tech" >
      <div class="items">
        <div class="posts">
          ...
          By
          <a class="post-author" href='profile.php' href="javascript:openProfile()" data-field="post-author"></a> under
          <a class="post-category post-category-pure" id="category" data-field="post-category"></a>
          <p class="post-description">
            <span data-field="post-description"></span>
            <a class="continue-reading" href="javascript:openArticle()">. . .Read More
    ...
    <div class="design">
      <div class="items">
        <div class="posts">
          ...
          By
          <a class="post-author" id="design-author" data-field="post-author" href="javascript:openProfile()"></a> under
          <a class="post-category post-category-pure" id="category" data-field="post-category"></a>
    ...
    <div class="fash">
      <div class="items">
        <div class="posts">
          ...
          By
          <a class="post-author" href="javascript:openProfile()" data-field="post-author" href="profile.php?user_name="></a> under
          <a class="post-category post-category-pure" id="category" data-field="post-category"></a>
