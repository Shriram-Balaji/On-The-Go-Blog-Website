...
<body class="g-body">
  <a class="close btn tooltipped" href="home.php" id="discard" data-position="left" data-delay="50" data-tooltip="Discard">
  ...
  <section>
    <form class="new-article" method="POST">
      ...
      <article class="content" name="article">
        <div>
          <p class="welcome-text">Welcome! Please read the
            <b>instructions below</b> and start typing your article highlighted below .</p>
        </div>
        <p class="focus"> </p>
  ...
  <div class="instructions">
    ...
    <ul>
      ...
      <li>
        <i>Press Enter Twice </i> to create a divider to separate your content.</li>
      <hr contenteditable="false">
    </ul>
